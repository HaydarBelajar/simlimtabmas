...
Route::middleware(['auth.token'])->group(function () {
    ...
    Route::group(['prefix'=>'penelitian','as'=>'penelitian.'], function() {
        ...
        Route::post('/upload-pengesahan/{id}', [\App\Http\Controllers\Admin\Penelitian\PenelitianController::class, 'uploadPengesahan'])->name('upload-pengesahan');
        Route::post('/upload-proposal/{id}', [\App\Http\Controllers\Admin\Penelitian\PenelitianController::class, 'uploadProposal'])->name('upload-proposal');
