...
class PerbaikanUsulanController extends Controller
{
    ...
    public function __construct()
    {
        $this->controllerDetails = [
            "currentPage" => "Perbaikan Usulan",
            "pageDescription" => "Halaman Perbaikan Usulan penelitian"
        ];
    }
    /**
    ...
    {
        return view('admin.content.penelitian.perbaikan-usulan.menu-perbaikan-usulan')->with([
